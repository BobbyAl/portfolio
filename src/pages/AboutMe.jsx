...
export default function AboutMe () {
    return (
        ...
        <div className="flex flex-col w-full gap-24 py-24">
            ...
            <div className="flex flex-col w-full max-w-6xl mx-auto gap-48 px-6">
                <TextType
                    ...
                    cursorCharacter="|"
                    loop={false}
                    className="flex-1 max-w-4xl text-4xl md:text-5xl font-semibold leading-tight tracking-tight text-white/90"

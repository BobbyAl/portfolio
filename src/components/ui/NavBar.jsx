        ...
        <div className="relative" ref={ref}>
            ...
            {open && (
                <div className={`absolute top-full mt-4 ${align === "right" ? "right-0" : "left-0"} z-50`}>
                    <div className="flex flex-col min-w-44 bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-1.5"
    ...
    return (
        <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-6">
            <div className="flex w-full max-w-5xl items-center justify-between gap-12 px-8 py-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-full shadow-2xl">
                ...
                {/* Logo */}
                <a href="/" className="flex gap-2 items-center cursor-pointer shrink-0">
                ...
                {/* Mobile nav — logo already on left, just two dropdowns */}
                <div className="flex md:hidden items-center gap-4">
                    ...
                    <MobileDropdown label="Connect" align="right">
